...
const defaultClientTypes = [
  {
    ...
    interactionStyle: "質問に素直に答え、沈黙を急かさず、落ち着いて会話を進める。",
    cooperationLevel: 5,
    itKnowledgeLevel: 2,
  },
  {
    ...
    interactionStyle: "専門用語をそのまま理解せず、日常業務に結びつく分かりやすい説明を求める。",
    cooperationLevel: 4,
    itKnowledgeLevel: 1,
  },
  {
    ...
    interactionStyle: "期限と影響を優先して確認し、実現可能な代替案と次回回答時刻を求める。",
    cooperationLevel: 3,
    itKnowledgeLevel: 2,
  },
  {
    id: "high-it-knowledge-client",
    displayName: "IT知識が高い顧客",
    description: "技術的な制約や選択肢を理解し、根拠を確認する顧客。",
    interactionStyle: "技術的な前提、制約、代替案の根拠を簡潔に確認する。",
    cooperationLevel: 4,
    itKnowledgeLevel: 5,
  },
  {
    id: "vague-client",
    displayName: "要望が曖昧な顧客",
    description: "課題や優先順位を明確に言語化できていない顧客。",
    interactionStyle: "抽象的な言葉で話すため、具体例や目的を質問されると情報を補足する。",
    cooperationLevel: 3,
    itKnowledgeLevel: 2,
  },
  {
    id: "quiet-client",
    displayName: "情報をあまり話さない顧客",
    description: "質問されるまで背景や制約をあまり話さない顧客。",
    interactionStyle: "自発的な説明を短く保ち、適切な質問にだけ必要な情報を追加する。",
    cooperationLevel: 3,
    itKnowledgeLevel: 2,
  },
  {
    id: "long-winded-client",
    displayName: "話が長く脱線する顧客",
    description: "関連する話題を次々に話し、論点が混ざりやすい顧客。",
    interactionStyle: "背景説明を長く話し、複数の論点を混ぜる。要約されると確認して会話を戻す。",
    cooperationLevel: 3,
    itKnowledgeLevel: 2,
  },
  {
    id: "decision-rushed-client",
    displayName: "結論を急ぐ顧客",
    description: "会話の途中でも結論や即答を求める顧客。",
    interactionStyle: "結論、選択肢、次の判断を短時間で求めるが、根拠ある保留は受け入れる。",
    cooperationLevel: 2,
    itKnowledgeLevel: 3,
  },
  {
    id: "budget-focused-client",
    displayName: "予算を重視する顧客",
    description: "費用対効果と予算内への収まりを重視する顧客。",
    interactionStyle: "費用、優先順位、段階的な実施方法を確認し、予算を超える提案には代替案を求める。",
    cooperationLevel: 3,
    itKnowledgeLevel: 2,
  },
  {
    id: "frequently-changing-client",
    displayName: "要望を頻繁に変更する顧客",
    description: "会話中にも要望や優先順位が変わりやすい顧客。",
    interactionStyle: "新しい要望を追加しやすく、前提を確認されると優先順位や理由を補足する。",
    cooperationLevel: 2,
    itKnowledgeLevel: 2,
  },
  {
    id: "argumentative-client",
    displayName: "反論が多い顧客",
    description: "説明の根拠や判断に対して質問・反論が多い顧客。",
    interactionStyle: "説明の根拠を確認し、安易な約束には反論する。人格を否定せず、事実と代替案には応じる。",
    cooperationLevel: 2,
    itKnowledgeLevel: 3,
  },
  {
    id: "emotionally-reactive-client",
    displayName: "感情的になりやすい顧客",
    description: "不安や不満が強いときに感情的な表現をする顧客。",
    interactionStyle: "困りごとや不安を強い言葉で表すことがあるが、人格攻撃はせず、共感と事実確認には応じる。",
    cooperationLevel: 2,
    itKnowledgeLevel: 2,
  },
];
...
const additionalTechnicalMvpScenarios: ScenarioDefinition[] = [
  createStandardScenario({
    ...
    focusSkillIds: ["ask-questions", "speak-slowly", "summarize-client-needs", "confirm-agreement"],
    allowedClientTypeIds: ["cooperative-client", "low-it-knowledge-client", "vague-client", "quiet-client", "long-winded-client"],
  }),
  createStandardScenario({
    ...
    focusSkillIds: ["speak-conclusion-first", "short-answer", "explain-additional-cost", "set-next-action"],
    allowedClientTypeIds: ["cooperative-client", "low-it-knowledge-client", "high-it-knowledge-client", "decision-rushed-client", "budget-focused-client"],
  }),
  createStandardScenario({
    ...
    focusSkillIds: ["summarize-client-needs", "confirm-agreement", "rephrase-technical-terms", "set-next-action"],
    allowedClientTypeIds: ["cooperative-client", "low-it-knowledge-client", "high-it-knowledge-client", "vague-client", "argumentative-client"],
  }),
  createStandardScenario({
    ...
    allowedClientTypeIds: ["cooperative-client", "quiet-client", "long-winded-client", "deadline-focused-client"],
  }),
  createStandardScenario({
    ...
    focusSkillIds: ["speak-conclusion-first", "say-check-needed", "apologize-with-action", "set-next-action"],
    allowedClientTypeIds: ["cooperative-client", "high-it-knowledge-client", "deadline-focused-client", "emotionally-reactive-client"],
  }),
  createStandardScenario({
    ...
    allowedClientTypeIds: ["cooperative-client", "long-winded-client", "argumentative-client", "emotionally-reactive-client"],
  }),
  createStandardScenario({
    ...
    allowedClientTypeIds: ["cooperative-client", "low-it-knowledge-client", "high-it-knowledge-client", "quiet-client", "budget-focused-client"],
  }),
  createStandardScenario({
    ...
    focusSkillIds: ["organize-topics", "summarize-client-needs", "confirm-agreement", "summarize-meeting", "set-next-action"],
    allowedClientTypeIds: ["cooperative-client", "quiet-client", "long-winded-client", "decision-rushed-client", "budget-focused-client", "frequently-changing-client"],
  }),
];
...
export const technicalMvpScenarioFixtures: ScenarioDefinition[] = [
  parseScenarioDefinition({
    ...
    evaluationRubric: {
      ...
      focusSkillIds: ["ask-questions", "voice-volume", "summarize-client-needs", "confirm-agreement"],
    },
  }),
    ...
    scenes: [
      {
        ...
        allowedDifficultyLevels: [1, 2, 3, 4, 5],
        allowedClientTypeIds: ["cooperative-client", "high-it-knowledge-client", "deadline-focused-client", "budget-focused-client", "frequently-changing-client", "argumentative-client"],
      },
    ],
    evaluationRubric: {
      requiredFactIds: ["requested-export-feature", "fixed-release-date", "budget-not-approved"],
      ...
      focusSkillIds: ["do-not-answer-immediately", "decline-request", "explain-additional-cost", "set-next-action"],
    },
  }),
  parseScenarioDefinition({
    ...
    scenes: [
      {
        ...
        allowedDifficultyLevels: [1, 2, 3, 4, 5],
        allowedClientTypeIds: ["cooperative-client", "deadline-focused-client", "argumentative-client", "emotionally-reactive-client"],
      },
    ],
    evaluationRubric: {
      requiredFactIds: ["delayed-feature", "cause-technical-risk", "new-deadline"],
